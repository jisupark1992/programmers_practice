...
public class 점프와_순간_이동 {
     ...
     *  아이언 슈트 구매자는 아이언 슈트를 착용하고 거리가 N 만큼 떨어져 있는 장소로 가려고 합니다. 단, 건전지 사용량을 줄이기 위해 점프로
     *  이동하는 것은 최소로 하려고 합니다. 아이언 슈트 구매자가 이동하려는 거리 N이 주어졌을 때, 사용해야 하는 건전지 사용량의 최솟값을
     ...
     *
     *   - 제약 조건
     *   1. 숫자 N은 1 이상 10억 이하의 자연수입니다.
     *   2. 숫자 K와 1 이상의 자연수입니다.
     *
     *   - 시간 복잡도 분석
